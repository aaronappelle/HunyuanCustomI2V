from .pipelines import HunyuanVideoCustomPipeline, HunyuanVideoPipelineI2V
...
def load_diffusion_pipeline(args, rank, vae, text_encoder, text_encoder_2, model, scheduler=None,
    ...
    if scheduler is None:
        scheduler = FlowMatchDiscreteScheduler(shift=args.flow_shift_eval_video,
    ...
    if args.i2v_mode:
        pipeline = HunyuanVideoPipelineI2V(
            vae=vae,
        ...
        pipeline = HunyuanVideoCustomPipeline(vae=vae,
                                        text_encoder=text_encoder,
                                        text_encoder_2=text_encoder_2,
                                        transformer=model,
                                        scheduler=scheduler,
